...
createServer(async (req, res) => {
  try {
    ...
    if (!/^\/(index\.html|styles\.css|favicon\.svg|THIRD_PARTY_LICENSES\.txt|src\/[a-z-]+\.js|data\/(questions|interview150|offer|scenarios|system-design|devops-sre|data-middleware|os-network)\.json|images\/[a-f0-9]+\.(png|jpe?g|gif|webp|svg))$/.test(route)) {
